...
import os
if not os.path.exists("frontier.mp4"):
    os.system("youtube-dl zvCvOC2VwDc -o knights.mp4")
    os.system("youtube-dl ERSom41oI9A -o frontier.mp4")
#==========
...
title = (CompositeVideoClip([dancing_knights.to_ImageClip()])
         .fadein(.5)
         .set_duration(3.5))
...
final = concatenate_videoclips([ dancing_knights])
